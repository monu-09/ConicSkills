...
public class ExamSelectableAdapter extends RecyclerView.Adapter implements SelectableViewHolder.OnItemSelectedListener {
    ...
    public ExamSelectableAdapter(SelectableViewHolder.OnItemSelectedListener listener,
