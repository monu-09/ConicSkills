...
public class TinyDB {
    ...
    private static TinyDB _instance;
    private SharedPreferences preferences;
  private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
  private String lastImagePath = "";
    private   int viewed_by_user_count ;
...
/*  public void putCounter(String key, Counter counter){
  ...
  public Counter getCounter(String key){
      ...
      Counter obj = gson.fromJson(json, Counter.class);
      return obj;
  }*/
  ...
  public void checkForNullValue(String value) {
    ...
    public static TinyDB getInstance(Context context) {
        if (_instance == null) {
            _instance = new TinyDB(context);
        }
        return _instance;
    }
    public int getViewed_by_user_count() {
        return viewed_by_user_count;
    }

    public void setViewed_by_user_count(int viewed_by_user_count) {
        this.viewed_by_user_count = viewed_by_user_count;
    }
