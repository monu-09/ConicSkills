...
//                Toast.makeText(context, R.string.error_drm_unknown, Toast.LENGTH_LONG).show();
                Log.e(
                        TAG,
...
//            Toast.makeText(context, toastStringId, Toast.LENGTH_LONG).show();
        ...
        private void onOfflineLicenseFetchedError(DrmSession.DrmSessionException e) {
            Toast.makeText(context, R.string.error_drm_unknown, Toast.LENGTH_LONG)
                    .show();
...
//              .copyWithKeySetId(keySetId);
            String check = mediaItem.mediaMetadata.title == null ? "" : mediaItem.mediaMetadata.title.toString();
            return downloadHelper
                    .getDownloadRequest(Util.getUtf8Bytes(check))
                            .copyWithKeySetId(keySetId);
        }
    }
