...
import com.conicskill.app.util.ytextractor.model.PlayerResponse;
import com.conicskill.app.util.ytextractor.model.Response;
import com.conicskill.app.util.ytextractor.model.StreamingData;
import com.conicskill.app.util.ytextractor.model.YTMedia;
import com.conicskill.app.util.ytextractor.model.YTSubtitles;
import com.conicskill.app.util.ytextractor.model.YoutubeMeta;
import com.conicskill.app.util.ytextractor.utils.HTTPUtility;
import com.conicskill.app.util.ytextractor.utils.LogUtils;
import com.conicskill.app.util.ytextractor.utils.RegexUtils;
import com.conicskill.app.util.ytextractor.utils.Utils;
...
public class YoutubeStreamExtractor extends AsyncTask<String, Void, Void> {
    ...
    public interface ExtractorListner {
        void onExtractionDone(List<YTMedia> adativeStream, List<YTMedia> muxedStream,
